...
export const generate_configure_account_proof: (a: number, b: number) => [number, number, number];
export const generate_transfer_proof: (a: number, b: number) => [number, number, number];
